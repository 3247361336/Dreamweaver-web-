...
<body>
	<div class="box">
		...
		<table border="1">
			...
			<tr>
				 ...
				 <td><div align="center"><span><img src="images/edt.gif" width="16" height="16" />编辑</a>&nbsp; &nbsp;<img src="images/del.gif" width="16" height="16" />删除</span></div></td>
			</tr>
			<?php } ?>
			<?php  }else{   ?>
	...
	<div class="add"><a href='./empAdd.php' >添加员工</div> 
	</div>
</body>
</html>