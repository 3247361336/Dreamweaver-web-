...
<body>
 ...
 <table border="1">
	...
	<tr>
		...
		<td><div align ="center"><span><img src="C:\wamp\www\111改\images\edt.gif"width="16" height="16">编辑&nbsp;&nbsp;<img src="C:\wamp\www\111改 \images\del.gif"width="16" height="16">删除</span></div></td>
		</tr>
		<?php } ?>
		<?php }else{ ?>
...
<div align="right"><a href='./empAdd.php'>添加员工</a></div>
</body>
</html>