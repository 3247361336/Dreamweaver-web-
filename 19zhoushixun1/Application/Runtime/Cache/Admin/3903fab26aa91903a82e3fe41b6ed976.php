...
<div class="main-right-table">
	...
	<table class="table">
		<tr>
			<th>图书号：</th><td><input type="text" class="form-text" name="book_id" required></td>
		</tr>
		<tr>
			<th>图书名：</th><td><input type="text" class="form-text" name="book_name" required>
		</tr>
		<tr>
			<th>作者：</th>
			<td><input type="text" class="form-text" name="book_author" required></td>
		</tr>
		<tr>
			<th>出版社：</th>
			<td><input type="text" class="form-text" name="publishing house" required></td>
		</tr>
		<tr>
