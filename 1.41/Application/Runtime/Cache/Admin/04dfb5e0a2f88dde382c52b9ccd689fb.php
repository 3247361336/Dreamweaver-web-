...
<head>
    <meta  charset="utf-8">
    <title>学生管理系统</title>
   <link href="/1.41/Public/css/style.css" rel="stylesheet">
</head>
<body>
<div class="top">
     <div class="top-box">
           ...
           <div class="top-box-nav">        
                                欢迎你！<a href="#">我的信息</a><a href="#">密码修改</a><a href="/1.41/index.php/Admin/Index/logout">安全退出</a>
           </div>
        </div>
      </div>
 <div class="main">
     ...
     <a href="/1.41/index.php/Admin/Major/show">专业列表</a>
     <a href="/1.41/index.php/Admin/Major/add">添加专业</a>
     <div class="main-left-nav-head">
     <strong>学生管理</strong>
     </div>
     <div class="main-left-nav-list">
     <div><a href="/1.41/index.php/Admin/Student/showList">学生列表</a></div>
     <div><a href="/1.41/index.php/Admin/Student/add">添加学生</a></div>
     <div><a href="/1.41/index.php/Admin/Student/addAll">批量添加</a></div>
     </div>
     <div class="main-left-nav-head">
...
<table>
   ...
   <?php if(!empty($major_info)): if(is_array($major_info)): foreach($major_info as $key=>$v): if(is_array($v["Class"])): foreach($v["Class"] as $k=>$vv): ?><tr>
                ...
                <td><a href="/1.41/index.php/Admin/Student/showList/class_id/<?php echo ($vv["class_id"]); ?>"><?php echo ($vv["class_name"]); ?></a></td>
                <td><div>编辑 删除</div></td>
