...
<div class="main-right-addAll">
	...
	<table class="table">
		...
		<tr align="center" class="js-student">
			...
			<td><img id="append" src="/19zhoushixun5/Public/images/append.png" /> <img id="remove" src="/19zhoushixun5/Public/images/remove.png" /></td>
		</tr>
		<tr>
...
<script src="/19zhoushixun5/Public/js/jquery.min.js"></script>
<script>
