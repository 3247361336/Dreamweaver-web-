...
<table class="table">
	...
	<?php if(!empty($student_info)): if(is_array($student_info)): foreach($student_info as $key=>$v): ?><tr align="center">
				...
				<td><div align="center"><a href="/19zhoushixun5/index.php/Admin/Student/update/student_id/<?php echo ($v["student_id"]); ?>">编辑</a>&nbsp; &nbsp;<a href="/19zhoushixun5/index.php/Admin/Student/delete/student_id/<?php echo ($v["student_id"]); ?>/class_id/<?php echo ($v["class_id"]); ?>"  onclick="javascript:if(confirm('确定要删除此信息吗？')){return true;}return false;">删除</a></div></td>
			</tr><?php endforeach; endif; ?>
		<?php else: ?>
		<tr align="center"><td colspan="5">查询的结果不存在！</td></tr><?php endif; ?>
</table>
<div><a href="/19zhoushixun5/index.php/Admin/Student/add/class_id/<?php echo ($class_id); ?>" class="main-right-tita">添加图书</a></div>
