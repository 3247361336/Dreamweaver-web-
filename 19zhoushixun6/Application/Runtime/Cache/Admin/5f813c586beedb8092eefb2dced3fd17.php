...
<div class="main-right-addAll">
	...
	<table class="table">
		...
		<tr align="center" class="js-student">
			<!--图书号-->
			<td><input type="text" class="form-text" name="student_id[]"></td>
			<!--图书名-->
			...
			<td><img id="append" src="/19zhoushixun6/Public/images/append.png" /> <img id="remove" src="/19zhoushixun6/Public/images/remove.png" /></td>
		</tr>
		<tr>
...
<script src="/19zhoushixun6/Public/js/jquery.min.js"></script>
<script>
